...
import { 
    ...
    FaFileContract, FaClipboardList, FaThLarge, FaList
} from "react-icons/fa";
        ...
        <Container fluid className="article-contrat-list-container py-4 px-4">
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>
                        <FaFileContract className="me-2 text-primary" />
                        {previewArticle?.libelle || "Aperçu de l'article"}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {previewArticle ? (
                        <>
                            <div className="mb-4 p-3 bg-light rounded">
                                ...
                                <div className="article-content-preview">
                                    {previewArticle.contenu || <span className="text-muted">Pas de contenu disponible</span>}
                                </div>
                            </div>
                                ...
                                <Row className="g-3">
                                    <Col md={6}>
                                        <Card className="h-100">
                                            <Card.Body>
                                                <h6>Information technique</h6>
                                                <small className="text-muted d-block mb-2">
                                                    ID: {previewArticle.id}
                                                </small>
                                                {previewArticle.contratDeTravailId && (
                                                    <small className="text-muted d-block">
                                                        Contrat associé: {previewArticle.contratDeTravailId}
                                                    </small>
                                                )}
                                            </Card.Body>
                                        </Card>
                                        ...
                                        <Card className="h-100 border-primary">
                                            <Card.Body className="d-flex flex-column justify-content-between">
                                                ...
                                                <div className="d-flex flex-wrap gap-2 mt-2">
                                                    <Button 
                                                        as={Link} 
                                                        to={`/article-contrat-travail/${previewArticle.id}`}
                                                        variant="outline-primary"
                                                        size="sm"
                                                    ...
                                                    <Button 
                                                        as={Link}
                                                        to={`/article-contrat-travail/edit/${previewArticle.id}`}
                                                        variant="outline-warning"
                                                        size="sm"
                                                        onClick={() => setShowPreview(false)}
                                                    >
